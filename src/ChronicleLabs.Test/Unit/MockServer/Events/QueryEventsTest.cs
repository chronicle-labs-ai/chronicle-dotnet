...
public class QueryEventsTest : BaseMockServerTest
{
    ...
    public async Task MockServerTest()
    {
        ...
        Server
            .Given(WireMock.RequestBuilders.Request.Create().WithPath("/v1/events").UsingGet())
            .RespondWith(
                WireMock
        ...
        var response = await Client.Events.QueryEventsAsync(new QueryEventsRequest());
