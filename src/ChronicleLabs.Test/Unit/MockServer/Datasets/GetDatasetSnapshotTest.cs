...
public class GetDatasetSnapshotTest : BaseMockServerTest
{
    ...
    public async global::System.Threading.Tasks.Task MockServerTest()
    {
        ...
        Server
            .Given(
                WireMock
                    ...
                    .WithPath("/v1/task-suites/dataset_id/snapshot")
                    .UsingGet()
            )
            .RespondWith(
                WireMock
        ...
        var response = await Client.Datasets.GetDatasetSnapshotAsync(
