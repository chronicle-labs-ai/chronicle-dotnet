...
public class CreateDatasetTaskTest : BaseMockServerTest
{
    ...
    public async global::System.Threading.Tasks.Task MockServerTest()
    {
        ...
        Server
            .Given(
                WireMock
                    ...
                    .WithPath("/v1/task-suites/dataset_id/tasks")
        ...
        var response = await Client.Datasets.CreateDatasetTaskAsync(
