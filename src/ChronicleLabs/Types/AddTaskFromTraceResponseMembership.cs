...
/// </summary>
[Serializable]
public record AddTaskFromTraceResponseMembership : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public AddTaskFromTraceResponseMembershipPurpose? Purpose { get; set; }
    ...
    public AddTaskFromTraceResponseMembershipSplit? Split { get; set; }
    ...
    public required AddTaskFromTraceResponseMembershipSubjectKind SubjectKind { get; set; }
