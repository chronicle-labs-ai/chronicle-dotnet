...
{
    public static readonly TaskStatus Ok = new(Values.Ok);

    public static readonly TaskStatus Warn = new(Values.Warn);

    public static readonly TaskStatus Error = new(Values.Error);
