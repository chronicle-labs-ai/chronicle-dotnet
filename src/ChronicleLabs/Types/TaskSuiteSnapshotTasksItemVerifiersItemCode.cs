...
/// </summary>
[Serializable]
public record TaskSuiteSnapshotTasksItemVerifiersItemCode : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required TaskSuiteSnapshotTasksItemVerifiersItemCodeLanguage Language { get; set; }
