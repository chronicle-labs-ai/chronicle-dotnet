...
[Serializable]
public record BacktestsAvailabilityDatasetSnapshotsValueDataset : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public BacktestsAvailabilityDatasetSnapshotsValueDatasetPurpose? Purpose { get; set; }
