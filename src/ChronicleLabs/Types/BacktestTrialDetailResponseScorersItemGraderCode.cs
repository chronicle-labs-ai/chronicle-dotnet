...
/// </summary>
[Serializable]
public record BacktestTrialDetailResponseScorersItemGraderCode : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required BacktestTrialDetailResponseScorersItemGraderCodeLanguage Language { get; set; }
