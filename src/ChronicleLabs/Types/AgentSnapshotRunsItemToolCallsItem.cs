...
[Serializable]
public record AgentSnapshotRunsItemToolCallsItem : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public AgentSnapshotRunsItemToolCallsItemError? Error { get; set; }
    ...
    public required AgentSnapshotRunsItemToolCallsItemStatus Status { get; set; }
