...
public record Task : IJsonOnDeserialized
{
    ...
    public TaskSplit? Split { get; set; }
    ...
    public required TaskSubjectKind SubjectKind { get; set; }
    ...
    public TaskTask? Task_ { get; set; }

    [JsonPropertyName("traceId")]
    public required string TraceId { get; set; }

    [JsonPropertyName("verifiers")]
    public IEnumerable<TaskVerifiersItem>? Verifiers { get; set; }
