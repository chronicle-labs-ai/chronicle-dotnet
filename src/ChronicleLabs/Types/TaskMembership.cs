...
/// </summary>
[Serializable]
public record TaskMembership : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public TaskMembershipPurpose? Purpose { get; set; }
    ...
    public TaskMembershipSplit? Split { get; set; }
    ...
    public required TaskMembershipSubjectKind SubjectKind { get; set; }
