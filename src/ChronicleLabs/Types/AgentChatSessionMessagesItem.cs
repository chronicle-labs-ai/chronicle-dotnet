...
[Serializable]
public record AgentChatSessionMessagesItem : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required AgentChatSessionMessagesItemRole Role { get; set; }

    /// <summary>
    /// Tool calls made while producing this message. Empty for user messages and failed turns.
    /// </summary>
    [JsonPropertyName("steps")]
    public IEnumerable<AgentChatSessionMessagesItemStepsItem>? Steps { get; set; }
