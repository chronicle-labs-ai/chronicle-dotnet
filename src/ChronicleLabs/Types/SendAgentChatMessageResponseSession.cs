...
/// </summary>
[Serializable]
public record SendAgentChatMessageResponseSession : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public IEnumerable<SendAgentChatMessageResponseSessionMessagesItem> Messages { get; set; } =
        new List<SendAgentChatMessageResponseSessionMessagesItem>();
