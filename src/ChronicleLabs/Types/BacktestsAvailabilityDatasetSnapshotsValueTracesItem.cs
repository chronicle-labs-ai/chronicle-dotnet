...
[Serializable]
public record BacktestsAvailabilityDatasetSnapshotsValueTracesItem : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public BacktestsAvailabilityDatasetSnapshotsValueTracesItemSplit? Split { get; set; }
    ...
    public required BacktestsAvailabilityDatasetSnapshotsValueTracesItemStatus Status { get; set; }
