...
/// </summary>
[Serializable]
public record BacktestJobDetailResponseRun : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required BacktestJobDetailResponseRunMode Mode { get; set; }
    ...
    public required BacktestJobDetailResponseRunStatus Status { get; set; }
