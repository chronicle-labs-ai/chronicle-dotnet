...
[Serializable]
public record CreateAgentChatSessionResponseSessionMessagesItem : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required CreateAgentChatSessionResponseSessionMessagesItemRole Role { get; set; }

    /// <summary>
    /// Tool calls made while producing this message. Empty for user messages and failed turns.
    /// </summary>
    [JsonPropertyName("steps")]
    public IEnumerable<CreateAgentChatSessionResponseSessionMessagesItemStepsItem>? Steps { get; set; }
