...
[Serializable]
public record TaskSuiteSnapshotTasksItemVerifiersItem : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public TaskSuiteSnapshotTasksItemVerifiersItemCode? Code { get; set; }
    ...
    public TaskSuiteSnapshotTasksItemVerifiersItemJudge? Judge { get; set; }

    [JsonPropertyName("kind")]
    public required TaskSuiteSnapshotTasksItemVerifiersItemKind Kind { get; set; }
    ...
    public required TaskSuiteSnapshotTasksItemVerifiersItemSource Source { get; set; }

    /// <summary>
    /// Grader weight bucket — `low | med | high` matches the segmented control in the GraderBuilder tray.
    /// </summary>
    [JsonPropertyName("weight")]
    public required TaskSuiteSnapshotTasksItemVerifiersItemWeight Weight { get; set; }
