...
[Serializable]
public record DatasetSavedViewState : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public IEnumerable<DatasetSavedViewStateFiltersItem>? Filters { get; set; }
    ...
    public IEnumerable<DatasetSavedViewStateSortingItem>? Sorting { get; set; }
