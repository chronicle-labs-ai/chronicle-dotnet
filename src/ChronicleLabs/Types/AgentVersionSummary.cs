...
[Serializable]
public record AgentVersionSummary : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required AgentVersionSummaryArtifact Artifact { get; set; }
    ...
    public required AgentVersionSummaryStatus Status { get; set; }
