...
[Serializable]
public record AgentSnapshotSummary : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required AgentSnapshotSummaryFramework Framework { get; set; }
    ...
    public required AgentSnapshotSummaryModel Model { get; set; }
