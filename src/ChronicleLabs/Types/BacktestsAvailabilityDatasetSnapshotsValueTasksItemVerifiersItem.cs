...
[Serializable]
public record BacktestsAvailabilityDatasetSnapshotsValueTasksItemVerifiersItem : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public BacktestsAvailabilityDatasetSnapshotsValueTasksItemVerifiersItemCode? Code { get; set; }
    ...
    public BacktestsAvailabilityDatasetSnapshotsValueTasksItemVerifiersItemJudge? Judge { get; set; }

    [JsonPropertyName("kind")]
    public required BacktestsAvailabilityDatasetSnapshotsValueTasksItemVerifiersItemKind Kind { get; set; }
    ...
    public required BacktestsAvailabilityDatasetSnapshotsValueTasksItemVerifiersItemSource Source { get; set; }

    /// <summary>
    /// Grader weight bucket — `low | med | high` matches the segmented control in the GraderBuilder tray.
    /// </summary>
    [JsonPropertyName("weight")]
    public required BacktestsAvailabilityDatasetSnapshotsValueTasksItemVerifiersItemWeight Weight { get; set; }
