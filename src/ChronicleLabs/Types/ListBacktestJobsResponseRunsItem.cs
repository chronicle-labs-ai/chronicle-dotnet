...
/// </summary>
[Serializable]
public record ListBacktestJobsResponseRunsItem : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required ListBacktestJobsResponseRunsItemMode Mode { get; set; }
    ...
    public required ListBacktestJobsResponseRunsItemStatus Status { get; set; }
