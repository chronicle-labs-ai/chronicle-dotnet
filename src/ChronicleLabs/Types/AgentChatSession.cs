...
/// </summary>
[Serializable]
public record AgentChatSession : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public IEnumerable<AgentChatSessionMessagesItem> Messages { get; set; } =
        new List<AgentChatSessionMessagesItem>();
