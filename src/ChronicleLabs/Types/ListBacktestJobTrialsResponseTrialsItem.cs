...
/// </summary>
[Serializable]
public record ListBacktestJobTrialsResponseTrialsItem : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public ListBacktestJobTrialsResponseTrialsItemException? Exception { get; set; }
    ...
    public required ListBacktestJobTrialsResponseTrialsItemStatus Status { get; set; }
    ...
    public required ListBacktestJobTrialsResponseTrialsItemTimings Timings { get; set; }
