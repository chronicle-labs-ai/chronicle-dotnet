...
[Serializable]
public record CreateBacktestJobRequestRecipeGradersItem : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public CreateBacktestJobRequestRecipeGradersItemCode? Code { get; set; }
    ...
    public CreateBacktestJobRequestRecipeGradersItemJudge? Judge { get; set; }

    [JsonPropertyName("kind")]
    public required CreateBacktestJobRequestRecipeGradersItemKind Kind { get; set; }
    ...
    public required CreateBacktestJobRequestRecipeGradersItemSource Source { get; set; }

    /// <summary>
    /// Grader weight bucket — `low | med | high` matches the segmented control in the GraderBuilder tray.
    /// </summary>
    [JsonPropertyName("weight")]
    public required CreateBacktestJobRequestRecipeGradersItemWeight Weight { get; set; }
