...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal async global::System.Threading.Tasks.Task<global::ChronicleLabs.Core.ApiResponse> SendRequestAsync(
        global::ChronicleLabs.Core.BaseRequest request,
    ...
    /// </summary>
    private async global::System.Threading.Tasks.Task<global::ChronicleLabs.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    )
    {
        ...
        if (!isRetryableContent || maxRetries == 0)
        {
            var response = await httpClient
                ...
                .ConfigureAwait(false);
            return new global::ChronicleLabs.Core.ApiResponse
            {
    ...
    private string BuildUrl(global::ChronicleLabs.Core.BaseRequest request)
    {
