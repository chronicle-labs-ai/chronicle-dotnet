...
public partial class LinksClient : ILinksClient
{
    private readonly RawClient _client;

    internal LinksClient(RawClient client)
    {
        _client = client;
    }
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<CreateLinkResponse>(responseBody)!;
                return new WithRawResponse<CreateLinkResponse>()
                {
                    Data = responseData,
                    RawResponse = new ChronicleLabs.RawResponse()
                    {
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<LinkEntityResponse>(responseBody)!;
                return new WithRawResponse<LinkEntityResponse>()
                {
                    Data = responseData,
                    RawResponse = new ChronicleLabs.RawResponse()
                    {
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<StatusResponse> AddEntityRefAsync(
        AddEntityRefRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<StatusResponse>(
            AddEntityRefAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<CreateLinkResponse> CreateEventLinkAsync(
        CreateLinkRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<CreateLinkResponse>(
            CreateEventLinkAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<LinkEntityResponse> LinkEntitiesAsync(
        LinkEntityRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<LinkEntityResponse>(
            LinkEntitiesAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<EventListResponse> TraverseGraphAsync(
        GraphRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<EventListResponse>(
            TraverseGraphAsyncCore(request, options, cancellationToken)
        );
    }
}
