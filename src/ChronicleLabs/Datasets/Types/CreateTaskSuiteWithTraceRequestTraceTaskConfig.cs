...
/// </summary>
[Serializable]
public record CreateTaskSuiteWithTraceRequestTraceTaskConfig : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public CreateTaskSuiteWithTraceRequestTraceTaskConfigNetworkMode? NetworkMode { get; set; }
