...
[Serializable]
public record CreateSavedViewRequestState : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public IEnumerable<CreateSavedViewRequestStateFiltersItem>? Filters { get; set; }
    ...
    public IEnumerable<CreateSavedViewRequestStateSortingItem>? Sorting { get; set; }
